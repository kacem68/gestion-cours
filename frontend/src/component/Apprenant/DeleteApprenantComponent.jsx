...
class DeleteApprenantComponent extends Component{
    ...
    onSubmit(values) {
        ...
        ApprenantDataService.deleteApprenant(values.id).then(() => this.Back());
    }
...
export default DeleteApprenantComponent;